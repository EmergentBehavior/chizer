...
class TestChizer(unittest.TestCase):
    ...
    def test_isChunksEncrypted(self):
        self.assertFalse(chizer.isChunksEncrypted("data/faked.dat"),"file encryption check test for faked data")
        self.assertTrue(chizer.isChunksEncrypted("data/ac59ab5a282afd3de22062c7d62b5367"),"file encryption check test for encrypted file")
